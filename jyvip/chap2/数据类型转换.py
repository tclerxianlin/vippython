# 教育机构：马士兵教育
# 讲师：杨淑娟
# 开发时间：2022/4/11 11:15
name = "张三"
age = 20
print(type(name),type(age)) #说明name与age的数据类型不相同
#print("我叫"+name+"今年"+age+"岁") #当将str类型与int类型进行连接时，报错，解决方案，类型转换。+号这里叫做连接符
...
s3 = 'hello'
i = 98
print(type(s1),type(s2),type(s3),type(s3),type(i))
print(float(s1),type(float(s1)))
print(float(s2),type(float(s2)))
print(float(ff),type(float(ff)))
#print(float(s3),type(float(s3)))   #字符串中的数据结果是非数字串，则不允许转换
